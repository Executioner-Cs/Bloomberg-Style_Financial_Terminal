...
async def get_ohlcv(
    symbol: str,
    timeframe: str = Query(default="1D", description="Timeframe: 1m, 5m, 15m, 1H, 4H, 1D, 1W, 1M"),
    from_date: str | None = Query(default=None, alias="from", description="Start date ISO 8601"),
    to_date: str | None = Query(default=None, alias="to", description="End date ISO 8601"),
) -> dict[str, object]:
